...
- The naming convention for plots is in most cases `sim<data_simulation>_mod<response_model><task>_config<configuration>` where the number for the simulation dataset and configuration can be checked in with entries in `.../conf`.

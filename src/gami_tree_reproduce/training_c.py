...
def main() -> None:
    ...
    TASKS = [
        ("model1_n500k_rho0", ROOT / "data" / "sim1_model1c.pq"),
        ("model2_n500k_rho0", ROOT / "data" / "sim1_model2c.pq"),
        ("model3_n500k_rho0", ROOT / "data" / "sim1_model3c.pq"),
        ("model4_n500k_rho0", ROOT / "data" / "sim1_model4c.pq"),

        ("model1_n500k_rho05", ROOT / "data" / "sim2_model1c.pq"),
        ("model2_n500k_rho05", ROOT / "data" / "sim2_model2c.pq"),
        ("model3_n500k_rho05", ROOT / "data" / "sim2_model3c.pq"),
        ("model4_n500k_rho05", ROOT / "data" / "sim2_model4c.pq"),

        ("model1_n50k_rho0", ROOT / "data" / "sim3_model1c.pq"),
        ("model2_n50k_rho0", ROOT / "data" / "sim3_model2c.pq"),
        ("model3_n50k_rho0", ROOT / "data" / "sim3_model3c.pq"),
        ("model4_n50k_rho0", ROOT / "data" / "sim3_model4c.pq"),

        ("model1_n50k_rho05", ROOT / "data" / "sim4_model1c.pq"),
        ("model2_n50k_rho05", ROOT / "data" / "sim4_model2c.pq"),
        ("model3_n50k_rho05", ROOT / "data" / "sim4_model3c.pq"),
        ("model4_n50k_rho05", ROOT / "data" / "sim4_model4c.pq"),
    ]

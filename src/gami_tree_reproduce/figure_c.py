...
from src.gami_tree_reproduce.training_c import cache_path, load_xy, split_50_25_25


ROOT = Path.cwd()
OUTDIR = ROOT / "figures_classification"
...
def load_cached(tag: str, task: str = "classification"):
